...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  RNFMAudioPlayer is the React Native wrapper for the Feed.fm Audio SDK
                   DESC
  s.homepage     = "https://github.com/SweatWorking/react-native-feed-media-audio-player/blob/master/example/node_modules/react-native-feed-media-audio-player/ios/RNFMAudioPlayer.podspec"
